...
const CardQuizResult = ({ data, disabled, longPress }: CardQuizResultProps) => {
    ...
    return (
        <TouchableOpacity className="bg-white/80 rounded-xl shadow-md flex-row border border-gray-200 items-center justify-between p-4" activeOpacity={1} onPress={handleOpenQuiz} disabled={disabled} onLongPress={longPress}>
